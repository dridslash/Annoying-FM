...
public class MeshCombineTool : ScriptableWizard
{
    public GameObject combineParent;
    public bool is32bit = true;

    [MenuItem("Hoptimist/Mesh Combine")]
    static void CreateWizard()
    {
        var wizard = DisplayWizard<MeshCombineTool>("Mesh Combine");
    ...
    void OnWizardCreate()
    {
        ...
        {
            Debug.LogError("Mesh Combine : Parent of objects to combne not assigned. Operation cancelled.");
            return;
        }
